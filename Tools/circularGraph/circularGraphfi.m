classdef circularGraphfi < handle
...
% Copyright 2014 The MathWorks, Inc.
  ...
  methods
    function this = circularGraphfi(adjacencyMatrix,varargin)
      % Constructor
      p = inputParser;
      
      defaultColorMap = repmat([1 1 1],[length(adjacencyMatrix) 1]);
      ...
      set(fig,...
        'UserData',this,...
        'CloseRequestFcn',@circularGraphfi.CloseRequestFcn);
